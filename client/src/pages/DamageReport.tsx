      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-white/5 px-4 py-4">
        <div className="flex items-center justify-between max-w-lg mx-auto">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground">Tectonix</span>
          </Link>
      ...
      <main className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        >
          <motion.button
            ...
            onTouchEnd={endHold}
            className="relative w-full py-5 rounded-2xl font-bold text-white overflow-hidden"
            style={{
